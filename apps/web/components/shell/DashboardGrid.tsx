...
const PANEL_ID_BY_COMPONENT: Record<string, string> = {
  ...
  OutcomeLedgerPanel: "outcome_ledger",
  LearningWorkerPanel: "learning_worker",
  MarketDataPanel: "market_data",
  MarketSessionsPanel: "market_sessions",
  MistakeMemoryPanel: "mistake_memory",
  HistoricalEdgePanel: "historical_edge",
  ConflictGateLearningPanel: "conflict_gate_learning",
  NewsPanel: "news",
