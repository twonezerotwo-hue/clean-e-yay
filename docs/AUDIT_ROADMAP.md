...
| B-4 | **Owner terfi paketi:** challenger champion'ı N eşleşmede + CI-ayrık geçerse governor defterine ÖNERİ (STRATEGY/WEIGHT). Owner onaylar; oto-uygulama YOK (KIRMIZI ÇİZGİ) | ⬜ B-3 sonrası | 🔴 | owner-onay |
